...
#define hf_color(r,g,b,a) (UIColor *)[UIColor colorWithRed:(float)r/255.0 green:(float)g/255.0 blue:(float)b/255.0 alpha:a]

#define hf_font(s) [UIFont systemFontOfSize:s+1]
